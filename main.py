...
TEST_MODE = False           # 🔥 SET FALSE IN PRODUCTION
...
def process_trades():
    ...
    for t in trades:
        try:
            ...
            # -----------------------
            # Record alert (NO confidence yet)
            # -----------------------
            record_alert(
                wallet=wallet,
                market=market,
            ...
            if TEST_MODE and TEST_MODE_ONE_SHOT:
                print("[TEST MODE] One alert sent. Stopping further alerts.")
                return True
...
def main():
    ...
    if TEST_MODE:
        print("⚠️ TEST MODE ENABLED — alerts are forced")
    ...
    while True:
        try:
            ...
            if stop:
                print("[INFO] Exiting after test alert")
                break
